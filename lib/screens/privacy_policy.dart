  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Privacy Policy',style: TextStyle(color: Colors.blue,fontWeight: FontWeight.bold,fontSize: 22.0),),
        centerTitle: true,
        leading: IconButton(
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              Text('VM Mobile built the Video and Image Downloader for Instagram app as a Free app.This SERVICE is provided by VM Mobile at no cost and is intended for use as is.This page is used to inform visitors regarding my policies with the collection, use, and disclosure of Personal Information if anyone decided to use my Service.If you choose to use my Service, then you agree to the collection and use of information in relation to this policy. The Personal Information that I collect is used for providing and improving the Service. I will not use or share your information with anyone except as described in this Privacy Policy.The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at Video and Image Downloader for Instagram unless otherwise defined in this Privacy Policy.',style: TextStyle(fontSize: 18.0),),
              SizedBox(height: 10.0,),
              ...
              SizedBox(height: 10.0,),
              Text('I may update our Privacy Policy from time to time. Thus, you are advised to review this page periodically for any changes. I will notify you of any changes by posting the new Privacy Policy on this page.This policy is effective as of 2021-03-17',style: TextStyle(fontSize: 18.0),),
              SizedBox(height: 10.0,),
              ...
              RaisedButton(
                ...
                color: Colors.blue,
                onPressed: () { launch('https://docs.google.com/document/d/12Omc-YR8a8pXa8PQRNplHNkTQ1etrcMVVUaL51A-LHU/edit?usp=sharing');},
              )
            ],
          ),
        ),
